				...
				<div class="dropdown">
					<a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown">
						<span class="user-icon">
							<img src="{{ asset('images/admin_images/'.Auth::guard('admin')->user()->image)  }}" alt="">
						</span>
						<span class="user-name">{{ ucwords(Auth::guard('admin')->user()->name) }}</span>
					</a>
					<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
						<a class="dropdown-item" href="profile.html"><i class="dw dw-user1"></i> Profile</a>
						<a class="dropdown-item" href="{{ url('admin/settings')}}"><i class="dw dw-settings2"></i> Setting</a>
