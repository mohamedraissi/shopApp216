								...
								<div class="tab height-100-p">
									...
									<div class="tab-content">	
										...
										<div class="tab-pane fade height-100-p show active" id="setting" role="tabpanel">
                                            ...
                                            @endif
												<form role="form" method="post" action="{{ url('/admin/add-subadmin') }}" name="addSubAdmin" 
                                                 id ="addSubAdmin" enctype="multipart/form-data"> @csrf
													<ul class="profile-edit-list row">
														<li class="weight-500 col-md-6">
                                                            ...
                                                            <div class="form-group">
																...
																<input class="form-control form-control-lg " name="admin_name" id="admin_name" placeholder="Enter admin name" >
								                               
															</div>
                                                            <div class="form-group">
																<label>Admin type</label>
																<input class="form-control form-control-lg " name="admin_type" id="admin_type" placeholder="Enter admin type" >
								                               
															</div>
                                                            <div class="form-group">
																<label>Admin Email</label>
																<input class="form-control form-control-lg"  name="email" id="email" placeholder="Enter admin email" >
															</div>
															<div class="form-group">
																<label>Admin password</label>
																<input class="form-control form-control-lg" type="password" name="password" id="password" placeholder="Enter admin password" >
															</div>
															<div class="form-group">
																<label>phone</label>
																<input class="form-control form-control-lg" name="admin_phone" id="admin_phone"  placeholder="Enterphone number" >
															</div>
															<div class="form-group">
																<label>image</label>
