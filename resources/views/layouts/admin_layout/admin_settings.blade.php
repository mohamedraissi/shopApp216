													...
													<ul class="profile-edit-list row">
														<li class="weight-500 col-md-6">
															...
															<div class="form-group">
																...
																<input class="form-control form-control-lg" value="{{ $adminDetails->name}}" placeholder="Enter admin or subadmin name"
                                                                 id="admin_name" name="admin_name">
															</div>
															<div class="form-group">
																<label>Admin Email</label>
																<input class="form-control form-control-lg" value="{{ $adminDetails->email}}" readonly="">
															</div>
															<div class="form-group">
																<label>Admin type</label>
																<input class="form-control form-control-lg"  value="{{ $adminDetails->type}}" readonly="">
															</div>
															<div class="form-group">
																<label>Current Password</label>
																<input class="form-control form-control-lg " type="password" name="current_pwd" id="current_pwd" placeholder="Enter current password" required="">
								                                 <span id="chkCurrentPassword" ></span>
															</div>
															<div class="form-group">
																<label>New Password</label>
																<input class="form-control form-control-lg" type="password" name="new_pwd" id="new_pwd" placeholder="Enter new password" required="">
															</div>
															<div class="form-group">
																<label>confirm Password</label>
																<input class="form-control form-control-lg"type="password" name="confirm_pwd" id="confirm_pwd" placeholder="confirm new password" required="">  
															</div>
