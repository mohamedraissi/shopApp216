        ...
        @endif
			<div class="min-height-200px">
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">Brands</h4>
						...
						<table class="data-table table nowrap dataTable no-footer dtr-inline collapsed">
							...
							<tbody>
								...
								<tr>
									...
									<td>
									@if($brand->status==1)
										<a class="updateBrandStatus"  id="brand-{{$brand->id }}" brand_id="{{$brand->id }}" href ="javascript::void(0)"> <span class="badge badge-success">	Active</span> </a>
									@else 
									<a class="updateBrandStatus"  id="brand-{{$brand->id }}" brand_id="{{$brand->id }}" href ="javascript::void(0)"><span class="badge badge-danger">	Inactive</span>  </a>
									@endif
									</td>
									...
									<td>
										<div class="dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-icon-list">
												...
												<a class="dropdown-item" href="{{url('admin/add-edit-brand/'.$brand->id) }}"><i class="dw dw-edit2"></i> Edit</a>

												<a   href="javascript:void(0)" class ="confirmDelete dropdown-item"    record="brand" recordid="{{$brand->id }}" >
